        ...
        <div class="card">
            <div class="card-body">
                <nav class="nav flex-column nav-pills nav-gap-y-1">
                    <router-link :to=" { name: 'viewPage' } "><p class="nav-item nav-link has-icon nav-link-faded" :class="retrieveComponentMethod == 'profileView' ? 'active' : ''" @click="emitRoute('profileView')">
                    ...
                    <router-link :to=" { name: 'changeUsername' } "><p class="nav-item nav-link has-icon nav-link-faded" :class="retrieveComponentMethod == 'changeUsername' ? 'active' : ''" @click="emitRoute('changeUsername')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings mr-2"><circle cx="12" cy="12" r="3">
                    ...
                    <router-link :to=" { name: 'changePassword' } "><p class="nav-item nav-link has-icon nav-link-faded" :class="retrieveComponentMethod == 'changePassword' ? 'active' : ''" @click="emitRoute('changePassword')">
                    ...
                    <router-link :to=" { name: 'biling' } "><p class="nav-item nav-link has-icon nav-link-faded" :class="retrieveComponentMethod == 'biling' ? 'active' : ''" @click="emitRoute('biling')">
