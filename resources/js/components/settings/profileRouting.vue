        ...
        <div class="card">
            <div class="card-body">
                <nav class="nav flex-column nav-pills nav-gap-y-1">
                    ...
                    <p class="nav-item nav-link has-icon nav-link-faded" :class="retrieveComponentMethod == 'changePassword' ? 'active' : ''" @click="emitRoute('changePassword')">
                    ...
                    <p class="nav-item nav-link has-icon nav-link-faded" :class="retrieveComponentMethod == 'biling' ? 'active' : ''" @click="emitRoute('biling')">
